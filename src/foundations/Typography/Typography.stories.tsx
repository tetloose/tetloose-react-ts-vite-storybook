  ...
  render: () => (
    ...
    >
      <Column
        ...
        width={{ default: 6 }}
      >
        <Typography tag={'h1'} size={'d1'} text={'Display 1'} padding={5} />
        <Typography tag={'h1'} size={'d2'} text={'Display 2'} padding={5} />
        <Typography tag={'h1'} size={'h1'} text={'H1'} padding={5} />
        <Typography tag={'h2'} size={'h2'} text={'H2'} padding={5} />
        <Typography tag={'h3'} size={'h3'} text={'H3'} padding={5} />
        <Typography tag={'h4'} size={'h4'} text={'H4'} padding={5} />
        <Typography tag={'h5'} size={'h5'} text={'H5'} padding={5} />
        <Typography tag={'h6'} size={'h6'} text={'H6'} padding={5} />
        <Typography tag={'p'} size={'body-sml'} text={'Body sml'} padding={5} />
        <Typography tag={'p'} size={'body-med'} text={'Body med'} padding={5} />
        <Typography tag={'p'} size={'body-lrg'} text={'Body lrg'} padding={5} />
        <Typography
          tag={'p'}
          size={'body-xlrg'}
          text={'Body xlrg'}
